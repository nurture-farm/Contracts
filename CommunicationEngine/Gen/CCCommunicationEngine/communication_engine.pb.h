...
class ActorDetails PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kToRecipientsFieldNumber = 8,
    kCcRecipientsFieldNumber = 9,
    kBccRecipientsFieldNumber = 10,
  ...
  int to_recipients_size() const;
  private:
  int _internal_to_recipients_size() const;
  public:
  void clear_to_recipients();
  const std::string& to_recipients(int index) const;
  std::string* mutable_to_recipients(int index);
  void set_to_recipients(int index, const std::string& value);
  void set_to_recipients(int index, std::string&& value);
  void set_to_recipients(int index, const char* value);
  void set_to_recipients(int index, const char* value, size_t size);
  std::string* add_to_recipients();
  void add_to_recipients(const std::string& value);
  void add_to_recipients(std::string&& value);
  void add_to_recipients(const char* value);
  void add_to_recipients(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& to_recipients() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_to_recipients();
  private:
  const std::string& _internal_to_recipients(int index) const;
  std::string* _internal_add_to_recipients();
  public:

  // repeated string cc_recipients = 9;
  int cc_recipients_size() const;
  private:
  int _internal_cc_recipients_size() const;
  public:
  void clear_cc_recipients();
  const std::string& cc_recipients(int index) const;
  std::string* mutable_cc_recipients(int index);
  void set_cc_recipients(int index, const std::string& value);
  void set_cc_recipients(int index, std::string&& value);
  void set_cc_recipients(int index, const char* value);
  void set_cc_recipients(int index, const char* value, size_t size);
  std::string* add_cc_recipients();
  void add_cc_recipients(const std::string& value);
  void add_cc_recipients(std::string&& value);
  void add_cc_recipients(const char* value);
  void add_cc_recipients(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& cc_recipients() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_cc_recipients();
  private:
  const std::string& _internal_cc_recipients(int index) const;
  std::string* _internal_add_cc_recipients();
  public:

  // repeated string bcc_recipients = 10;
  int bcc_recipients_size() const;
  private:
  int _internal_bcc_recipients_size() const;
  public:
  void clear_bcc_recipients();
  const std::string& bcc_recipients(int index) const;
  std::string* mutable_bcc_recipients(int index);
  void set_bcc_recipients(int index, const std::string& value);
  void set_bcc_recipients(int index, std::string&& value);
  void set_bcc_recipients(int index, const char* value);
  void set_bcc_recipients(int index, const char* value, size_t size);
  std::string* add_bcc_recipients();
  void add_bcc_recipients(const std::string& value);
  void add_bcc_recipients(std::string&& value);
  void add_bcc_recipients(const char* value);
  void add_bcc_recipients(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& bcc_recipients() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_bcc_recipients();
  private:
  const std::string& _internal_bcc_recipients(int index) const;
  std::string* _internal_add_bcc_recipients();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> to_recipients_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> cc_recipients_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> bcc_recipients_;
...
// repeated string to_recipients = 8;
inline int ActorDetails::_internal_to_recipients_size() const {
  return to_recipients_.size();
}
inline int ActorDetails::to_recipients_size() const {
  return _internal_to_recipients_size();
}
inline void ActorDetails::clear_to_recipients() {
  to_recipients_.Clear();
}
inline std::string* ActorDetails::add_to_recipients() {
  // @@protoc_insertion_point(field_add_mutable:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  return _internal_add_to_recipients();
}
inline const std::string& ActorDetails::_internal_to_recipients(int index) const {
  return to_recipients_.Get(index);
}
inline const std::string& ActorDetails::to_recipients(int index) const {
  // @@protoc_insertion_point(field_get:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  return _internal_to_recipients(index);
}
inline std::string* ActorDetails::mutable_to_recipients(int index) {
  // @@protoc_insertion_point(field_mutable:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  return to_recipients_.Mutable(index);
}
inline void ActorDetails::set_to_recipients(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  to_recipients_.Mutable(index)->assign(value);
}
inline void ActorDetails::set_to_recipients(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  to_recipients_.Mutable(index)->assign(std::move(value));
}
inline void ActorDetails::set_to_recipients(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  to_recipients_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline void ActorDetails::set_to_recipients(int index, const char* value, size_t size) {
  to_recipients_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline std::string* ActorDetails::_internal_add_to_recipients() {
  return to_recipients_.Add();
}
inline void ActorDetails::add_to_recipients(const std::string& value) {
  to_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline void ActorDetails::add_to_recipients(std::string&& value) {
  to_recipients_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline void ActorDetails::add_to_recipients(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  to_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline void ActorDetails::add_to_recipients(const char* value, size_t size) {
  to_recipients_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ActorDetails::to_recipients() const {
  // @@protoc_insertion_point(field_list:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  return to_recipients_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ActorDetails::mutable_to_recipients() {
  // @@protoc_insertion_point(field_mutable_list:farm.nurture.core.contracts.ce.ActorDetails.to_recipients)
  return &to_recipients_;
}

// repeated string cc_recipients = 9;
inline int ActorDetails::_internal_cc_recipients_size() const {
  return cc_recipients_.size();
}
inline int ActorDetails::cc_recipients_size() const {
  return _internal_cc_recipients_size();
}
inline void ActorDetails::clear_cc_recipients() {
  cc_recipients_.Clear();
}
inline std::string* ActorDetails::add_cc_recipients() {
  // @@protoc_insertion_point(field_add_mutable:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  return _internal_add_cc_recipients();
}
inline const std::string& ActorDetails::_internal_cc_recipients(int index) const {
  return cc_recipients_.Get(index);
}
inline const std::string& ActorDetails::cc_recipients(int index) const {
  // @@protoc_insertion_point(field_get:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  return _internal_cc_recipients(index);
}
inline std::string* ActorDetails::mutable_cc_recipients(int index) {
  // @@protoc_insertion_point(field_mutable:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  return cc_recipients_.Mutable(index);
}
inline void ActorDetails::set_cc_recipients(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  cc_recipients_.Mutable(index)->assign(value);
}
inline void ActorDetails::set_cc_recipients(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  cc_recipients_.Mutable(index)->assign(std::move(value));
}
inline void ActorDetails::set_cc_recipients(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  cc_recipients_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline void ActorDetails::set_cc_recipients(int index, const char* value, size_t size) {
  cc_recipients_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline std::string* ActorDetails::_internal_add_cc_recipients() {
  return cc_recipients_.Add();
}
inline void ActorDetails::add_cc_recipients(const std::string& value) {
  cc_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline void ActorDetails::add_cc_recipients(std::string&& value) {
  cc_recipients_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline void ActorDetails::add_cc_recipients(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  cc_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline void ActorDetails::add_cc_recipients(const char* value, size_t size) {
  cc_recipients_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ActorDetails::cc_recipients() const {
  // @@protoc_insertion_point(field_list:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  return cc_recipients_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ActorDetails::mutable_cc_recipients() {
  // @@protoc_insertion_point(field_mutable_list:farm.nurture.core.contracts.ce.ActorDetails.cc_recipients)
  return &cc_recipients_;
}

// repeated string bcc_recipients = 10;
inline int ActorDetails::_internal_bcc_recipients_size() const {
  return bcc_recipients_.size();
}
inline int ActorDetails::bcc_recipients_size() const {
  return _internal_bcc_recipients_size();
}
inline void ActorDetails::clear_bcc_recipients() {
  bcc_recipients_.Clear();
}
inline std::string* ActorDetails::add_bcc_recipients() {
  // @@protoc_insertion_point(field_add_mutable:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  return _internal_add_bcc_recipients();
}
inline const std::string& ActorDetails::_internal_bcc_recipients(int index) const {
  return bcc_recipients_.Get(index);
}
inline const std::string& ActorDetails::bcc_recipients(int index) const {
  // @@protoc_insertion_point(field_get:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  return _internal_bcc_recipients(index);
}
inline std::string* ActorDetails::mutable_bcc_recipients(int index) {
  // @@protoc_insertion_point(field_mutable:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  return bcc_recipients_.Mutable(index);
}
inline void ActorDetails::set_bcc_recipients(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  bcc_recipients_.Mutable(index)->assign(value);
}
inline void ActorDetails::set_bcc_recipients(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  bcc_recipients_.Mutable(index)->assign(std::move(value));
}
inline void ActorDetails::set_bcc_recipients(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  bcc_recipients_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline void ActorDetails::set_bcc_recipients(int index, const char* value, size_t size) {
  bcc_recipients_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline std::string* ActorDetails::_internal_add_bcc_recipients() {
  return bcc_recipients_.Add();
}
inline void ActorDetails::add_bcc_recipients(const std::string& value) {
  bcc_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline void ActorDetails::add_bcc_recipients(std::string&& value) {
  bcc_recipients_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline void ActorDetails::add_bcc_recipients(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  bcc_recipients_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline void ActorDetails::add_bcc_recipients(const char* value, size_t size) {
  bcc_recipients_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ActorDetails::bcc_recipients() const {
  // @@protoc_insertion_point(field_list:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  return bcc_recipients_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ActorDetails::mutable_bcc_recipients() {
  // @@protoc_insertion_point(field_mutable_list:farm.nurture.core.contracts.ce.ActorDetails.bcc_recipients)
  return &bcc_recipients_;
}
